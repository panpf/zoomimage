 ...
 */
@Composable
fun <DataT : Any> rememberGlidePreloadingData(
  dataSize: Int,
 ...
 */
interface GlidePreloadingData<DataT> {
   ...
   */
  @Composable
  operator fun get(index: Int): Pair<DataT, RequestBuilder<Drawable>>
}
 ...
 */
typealias PreloadRequestBuilderTransform<DataTypeT> =

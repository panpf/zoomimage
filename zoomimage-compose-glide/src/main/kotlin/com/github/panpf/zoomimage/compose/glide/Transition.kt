...
interface Transition {
   ...
   * be re-drawn.
   */
  suspend fun transition(invalidate: () -> Unit)
   ...
   */
  val drawPlaceholder: DrawPainter?
...
typealias DrawPainter = DrawScope.(Painter, Size, Float, ColorFilter?) -> Unit

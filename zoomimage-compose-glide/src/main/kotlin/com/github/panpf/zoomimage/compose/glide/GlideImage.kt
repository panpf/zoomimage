 ...
 */
@ExperimentalGlideComposeApi
interface GlideSubcompositionScope {
 ...
 */
@ExperimentalGlideComposeApi
fun placeholder(@DrawableRes resourceId: Int): Placeholder =
 ...
 */
@ExperimentalGlideComposeApi
fun placeholder(painter: Painter?): Placeholder =
...
@ExperimentalGlideComposeApi
fun placeholder(composable: @Composable () -> Unit): Placeholder =

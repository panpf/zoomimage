...
//        }
//
//        resetLoadRect(contentVisibleRect)
//
//        if (contentVisibleRect.isEmpty) {
//            logger.d {
//                "refreshTiles:$caller. interrupted, contentVisibleRect is empty. " +
...
//    }
//
//    private fun resetLoadRect(contentVisibleRect: IntRectCompat) {
//        if (lastContentVisibleRect == contentVisibleRect) {
//            return
//        }
//        lastContentVisibleRect = contentVisibleRect
...
//        )
//
//        notifyLoadRectChanged()
//    }
//
//    private fun resetSampleSize(scale: Float) {
//        val lastScale = lastScale
//        val lastSampleSize = lastSampleSize
//        if (lastSampleSize != 0 && scale == lastScale) {
//            return
//        }
//        val sampleSize = findSampleSize(
//            imageWidth = imageInfo.width,
...
//        // todo notifySampleSizeChanged
//        categoryTiles()
//    }
//
//    private fun notifyLoadRectChanged() {
//        categoryTiles()
//        onImageLoadRectChanged(this)
//    }
//
//    private fun categoryTiles() {
//        val (backgroundTiles, foregroundTiles, otherTiles) = calculateDrawTiles(
//            sortedTileMap = sortedTileMap,
//            currentSampleSize = lastSampleSize ?: 1,
//            imageLoadRect = imageLoadRect
//        )
//        updateDrawTiles()
//    }
//
//    private fun updateDrawTiles() {
...
//    }
//
//    private fun calculateDrawTiles(
//        sortedTileMap: Map<Int, List<Tile>>,
//        currentSampleSize: Int,
//        imageLoadRect: IntRectCompat
//    ): Array<List<Tile>> {
//        val backgroundTiles = LinkedList<Tile>()
//        val foregroundTiles = LinkedList<Tile>()
//        val otherTiles = LinkedList<Tile>()
//        sortedTileMap.entries.forEach { (sampleSize, tiles) ->
...
//                    }
//                }
//            } else if (sampleSize == currentSampleSize) {
//                tiles.forEach { tile ->
//                    if (tile.srcRect.overlaps(imageLoadRect)) {
...
//            }
//        }
//        return arrayOf(backgroundTiles, foregroundTiles, otherTiles)
//    }
//}
...
import com.github.panpf.zoomimage.annotation.IntRange
 ...
 * 生成图片指纹
 */
fun produceFingerPrint(source: BufferedImage): String {
    val width = 8
    val height = 8
    // 第一步，缩小尺寸。
...
private fun recycleBufferedImage(thumb: BufferedImage) {
...
private fun rgbToGray(pixels: Int): Int {
    ...
    val _red = red(pixels)
    val _green = green(pixels)
    val _blue = blue(pixels)

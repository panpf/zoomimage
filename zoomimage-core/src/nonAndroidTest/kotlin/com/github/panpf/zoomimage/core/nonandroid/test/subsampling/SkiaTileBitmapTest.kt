...
class SkiaTileBitmapTest {
    ...
    fun testConstructor() {
        ...
        SkiaTileBitmap(bitmap1, "bitmap1", BitmapFrom.LOCAL).apply {
            assertSame(bitmap1, bitmap)
            assertEquals("bitmap1", key)
            assertEquals(bitmapFrom, BitmapFrom.LOCAL)
        }
        SkiaTileBitmap(bitmap2, "bitmap2", BitmapFrom.MEMORY_CACHE).apply {
    ...
    fun testWidthHeightByteCount() {
        ...
        val skiaTileBitmap1 = SkiaTileBitmap(bitmap1, "bitmap1", BitmapFrom.LOCAL).apply {
        ...
        val skiaTileBitmap12 = SkiaTileBitmap(bitmap12, "bitmap12", BitmapFrom.LOCAL).apply {
        ...
        val skiaTileBitmap2 = SkiaTileBitmap(bitmap2, "bitmap2", BitmapFrom.LOCAL).apply {
    ...
    fun testRecycle() {
        ...
        val skiaTileBitmap = SkiaTileBitmap(bitmap, "bitmap1", BitmapFrom.LOCAL)
    ...
    fun testEqualsAndHashCode() = runTest {
        ...
        val tileBitmap1 = SkiaTileBitmap(bitmap1, "bitmap1", BitmapFrom.LOCAL)
        val tileBitmap12 = SkiaTileBitmap(bitmap1, "bitmap1", BitmapFrom.LOCAL)
        val tileBitmap2 = SkiaTileBitmap(bitmap2, "bitmap2", BitmapFrom.LOCAL)
    ...
    fun testToString() = runTest {
        ...
        val tileBitmap1 = SkiaTileBitmap(bitmap1, "bitmap1", BitmapFrom.LOCAL)
        val tileBitmap2 = SkiaTileBitmap(bitmap2, "bitmap2", BitmapFrom.MEMORY_CACHE)

        assertEquals(
            expected = "SkiaTileBitmap(key='bitmap1', bitmap=${bitmap1.toLogString()}, bitmapFrom=LOCAL)",
            actual = tileBitmap1.toString()
        )
        assertEquals(
            expected = "SkiaTileBitmap(key='bitmap2', bitmap=${bitmap2.toLogString()}, bitmapFrom=MEMORY_CACHE)",

...
import com.github.panpf.zoomimage.core.test.internal.ViewPlatformUtilsKt;
...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    public void put(@NonNull Bitmap bitmap) {
        int size = ViewPlatformUtilsKt.getAllocationByteCountCompat(bitmap);
    ...
    public Bitmap get(int width, int height, @Nullable Bitmap.Config config) {
        int size = ViewPlatformUtilsKt.calculateBitmapByteCount(width, height, config);
        ...
        if (result != null) {
            ...
            try {
                ...
                String message = String.format(Locale.getDefault(),
                        ...
                        width, height, config, ViewPlatformUtilsKt.getLogString(result)
                );
    ...
    public Bitmap removeLast() {
        ...
        if (removed != null) {
            int removedSize = ViewPlatformUtilsKt.getAllocationByteCountCompat(removed);
    ...
    public int getSize(@NonNull Bitmap bitmap) {
        return ViewPlatformUtilsKt.getAllocationByteCountCompat(bitmap);
    }

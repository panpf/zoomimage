...
import com.github.panpf.zoomimage.util.computeContentInContainerInnerRect
...
//    }
    ...
    private fun List<Item>.printlnExpectedMessage(computeExpected: (Item) -> IntRectCompat): List<Item> {
        this.map {
    ...
    private fun List<Item3>.printlnExpectedMessage3(computeExpected: (Item3) -> IntRectCompat): List<Item3> {
        this.map {

 ...
 * @see com.github.panpf.zoomimage.compose.sketch4.test.SingletonSketchZoomAsyncImageTest.testSketchZoomAsyncImage1
 */
@Composable
 ...
 * @param onLongPress Called when the user long presses the image
 * @param onTap Called when the user taps the image
 * @see com.github.panpf.zoomimage.compose.sketch4.test.SingletonSketchZoomAsyncImageTest.testSketchZoomAsyncImage2
 */
@Composable
@NonRestartableComposable
fun SketchZoomAsyncImage(

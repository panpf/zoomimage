...
class TileManagerTest {
    ...
    private class TileManagerHolder(assetName: String = "sample_long_comic.jpg") : Closeable {
        ...
        private val tileBitmapPoolHelper = TileBitmapReuseHelper(logger)
        private val tileBitmapCacheHelper = TileBitmapCacheHelper(logger)
        ...
        val tileManager = TileManager(
            ...
            tileBitmapReuseHelper = tileBitmapPoolHelper,

...
abstract class BaseZoomImageViewPagerFragment : ToolbarBindingFragment<TabPagerFragmentBinding>() {

    abstract val title: String

    abstract fun createItemFactoryList(): List<FragmentItemFactory<String>>
    ...
    override fun onViewCreated(
        ...
        binding.tabPagerPager.apply {
            ...
            adapter = AssemblyFragmentStateAdapter(
                fragment = this@BaseZoomImageViewPagerFragment,
                itemFactoryList = createItemFactoryList(),

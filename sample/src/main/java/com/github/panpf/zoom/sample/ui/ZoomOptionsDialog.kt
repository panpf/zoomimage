...
import com.github.panpf.zoom.name
import com.github.panpf.zoom.sample.ui.base.compose.TitleRadioButton
...
@Composable
fun rememberZoomOptionsDialogState(): ZoomOptionsDialogState =
    remember { ZoomOptionsDialogState() }

@Composable
fun rememberZoomOptionsDialogConfig(): ZoomOptionsDialogConfig =
    remember { ZoomOptionsDialogConfig() }

@Composable
fun ZoomOptionsDialog(
    state: ZoomOptionsDialogState = rememberZoomOptionsDialogState(),
    config: ZoomOptionsDialogConfig = rememberZoomOptionsDialogConfig(),

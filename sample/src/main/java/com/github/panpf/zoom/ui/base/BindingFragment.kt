 ...
 */
package com.github.panpf.zoom.ui.base
...
import com.github.panpf.zoom.ui.util.createViewBinding
import com.github.panpf.zoom.ui.util.getWindowBackground
...
abstract class BindingFragment<VIEW_BINDING : ViewBinding> : Fragment() {
    ...
    final override fun onCreateView(
        ...
        if (root.background == null) {
            root.setBackgroundResource(inflater.context.getWindowBackground())
        }
    }.root
